 ...
 * @param dst
 */
void transpose_tiled(int M, int N, float *src, float *dst)
{
 ...
 * @param C
 */
void matrixMultiply_naive(int M, int N, int K, float *A, float *B, float *C)
{
    int i, j, k;
 ...
 * @param C
 */
void matrixMultiply_tiled(int M, int N, int K, float *A, float *B, float *C)
{
    for (int i = 0; i < M; i += BS)
        for (int j = 0; j < N; j += BS)
 ...
 * @param C
 */
void matrixMultiply_transposed(int M, int N, int K, float *A, float *Bt, float *C)
{
    for (int i = 0; i < M; ++i)
        for (int j = 0; j < N; ++j)
        {
 ...
 * @param C
 */
void matrixMultiply_transposed_vectorized(int M, int N, int K, float *A, float *Bt, float *C)
{
    for (int i = 0; i < M; ++i)
        for (int j = 0; j < N; ++j)
        {
 ...
 * @param C
 */
void matrixMultiply_transposed_parallelized_vectorized(int M, int N, int K, float *A, float *Bt, float *C)
{
 ...
 * @param C
 */
void matrixMultiply_transposed_parallelized_tiled_vectorized(int M, int N, int K, float *A, float *Bt, float *C)
{
...
int main(int argc, char **argv)
{
    ...
    void (*orderings[])(int, int, int, float *, float *, float *) = {&matrixMultiply_naive,
                                                                     &matrixMultiply_tiled,
                                                                     &matrixMultiply_transposed,
                                                                     &matrixMultiply_transposed_vectorized,
                                                                     &matrixMultiply_transposed_parallelized_vectorized,
                                                                     &matrixMultiply_transposed_parallelized_tiled_vectorized};
    std::string names[] = {"Naive",
                           "Tiled",
                           "Transposed",
                           "Transposed + Vectorized",
                           "Transposed + Parallelized + Vectorized",
                           "Transposed + Parallelized + Tiled + Vectorized",};
